...
export default function LaunchPage() {
  return <main className="launch-page">
    ...
    <div className="launch-telemetry" aria-label="Mission telemetry"><span>ORIGIN<br /><b>EARTH</b></span><span>DESTINATION<br /><b>MARS</b></span><span>VEHICLE<br /><b>MA-01</b></span></div>
  </main>;
}
